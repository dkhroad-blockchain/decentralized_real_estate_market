...
contract Ownable {
    ...
    /**
      * @dev set the deployer as the initial owner.
      */
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner.isContract() == false,"New Owner must be an EOA");
...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        ...
        // remember the functions to use for Counters. 
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] != to,"Given address is owner of the token");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _tokenOwner[tokenId] ||
                isApprovedForAll(_tokenOwner[tokenId],msg.sender),
                "Sender must be the owner or an approved owner");
    ...
    // remember the functions to use for Counters. you can refresh yourself with the link above
    function _mint(address to, uint256 tokenId) internal {

        //revert if given tokenId already exists or
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == from,"Transferor is not the owner");


        // TODO: require token is being transfered to valid address
        require(to != address(0x0),"Transferee is not a valid address");
...
//  RealEstateERC721Token contract that inherits from the ERC721Metadata contract. 
contract ERC721PropertyToken is ERC721Metadata {
    
    string constant baseTokenURI = "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/";
